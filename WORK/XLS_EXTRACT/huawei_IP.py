...
sh = xlrd.open_workbook('MPLS IP STORE ALLOCATION V_16.28.xlsx').sheet_by_index(0)
plik = open("hswitchip.csv", 'w')
...
import csv
r = csv.reader(open('hswitchip.csv')) # Here your csv file
lines = list(r)
lines[0][2] = 'Network'
writer = csv.writer(open('HuaweiIP_'+dt+'.csv', 'w'))
